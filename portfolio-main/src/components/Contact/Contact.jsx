      ...
      <div className="d-flex align-items-center justify-content-center">
        <div className="w-100">
          ...
          <div className="fs-5 text-center">
            Welcome!<br/>
            Got a question or proposal, or just want to say hello? Well, go ahead.
          </div>
          <div className="fs-5 text-center">
            Either way, you can also review my repositories or connect with me.
          </div>
          <div className="d-flex gap-4 justify-content-center py-3 py-lg-0 pt-lg-3">
            <a
              href="https://github.com/Santiago-Miranda"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/santiago-miranda-815739207/"
              target="_blank"
              className="text-decoration-none link-social"
              rel="noreferrer"
            >
